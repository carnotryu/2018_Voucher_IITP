...
short fsr1_raw, fsr1_raw_f, fsr1_mm;
short fsr1_min = 270, fsr1_max = 700;
int pos1_raw, pos1_raw_f, pos1_mm;
int pos1_min = 40, pos1_max = 400;
float pos1_des;
...
void setup() {
  ...
  digitalWrite(34,LOW);
  fsr1_raw_f = readDataFromSensor(i2cAddress1);
}
...
/*
  if (mod == 5)
  {
    ...
    else                    pos1_des = (fsr1 - max_force) / (500.0 - max_force) * (-(stop_pos1 + 0.5)) + (stop_pos1 + 0.5); // max ~ 500 -> 5.5mm ~ 0 mm  
  }
*/
...
short readDataFromSensor(short address)
{
  ...
  return rawData;
>>>>>>> 045c283f3deae1824a8df386af9805504ce4d8f9
}
